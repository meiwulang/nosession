...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "D:\\eclipse-workspace3\\mall-full-jhd\\mall-uag\\src\\main\\webapp\\app\\components\\orderManagement.vue"
					...
					if (jsonData.error_no == 0) {
						if (jsonData.data) {
							jsonData.data.items = jsonData.data.items.map(function (item) {
								...
								if (item.terminalDate) {
									item.terminalDate = _common2.default.time2DateFormat(item.terminalDate);
								}
								return item;
							});
						}
	  ...
	  return _c('div', {
	    ...
	    scopedSlots: _vm._u([{
	      ...
	      fn: function(scope) {
	        ...
	        }, [_vm._v("等待支付余款")]) : _vm._e()]) : _vm._e(), _vm._v(" "), (scope.row.terminalDate) ? _c('div', [_vm._v("\n\t\t\t\t\t\t\t\t\t订单关闭时间：" + _vm._s(scope.row.terminalDate) + "\n\t\t\t\t\t\t\t\t")]) : _vm._e()]), _vm._v(" "), _vm._l((scope.row.productList), function(item) {
	          return _c('ul', {
	    ...
	    scopedSlots: _vm._u([{
	      ...
	      fn: function(scope) {
	        ...
	        }, [_vm._v(_vm._s(scope.row.userName))])]), _vm._v(" "), _c('div', [_vm._v(_vm._s(scope.row.userMobile))]), _vm._v(" "), _c('div', [_vm._v(_vm._s(scope.row.inviteCode))])]
	      }
	    }])
	  }), _vm._v(" "), _c('el-table-column', {
	    attrs: {
