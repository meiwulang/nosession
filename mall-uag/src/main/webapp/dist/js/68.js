...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/xiangyangli/projects/hjh/jhd/mall-uag/src/main/webapp/app/components/prepareProduct.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] prepareProduct.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-8bc47942", Component.options)
	  } else {
	    hotAPI.reload("data-v-8bc47942", Component.options)
	  }
	})()}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(29)("24b99b9a", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8bc47942!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./prepareProduct.vue", function() {
	     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8bc47942!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./prepareProduct.vue");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		methods: {
			...
			//预览商品
			productView: function productView(val) {},
	
			//编辑商品
			modifyGoods: function modifyGoods(val) {
				location.href = "#/modifyProduct/" + val;
			},
			...
			delGoods: function delGoods(val) {
				...
				this.$confirm('确定要删除该商品吗？', '提示', {
					...
					_this2.$http.post('/delGoods', { goods_id: val, access_token: localStorage.access_token }).then(function (response) {
						var jsondata = response.data;
						that.$message({
							type: jsondata.error_no == 0 ? "success" : "error",
							message: jsondata.error_no == 0 ? "操作成功" : jsondata.error_info
			...
			modifyGoodsStatus: function modifyGoodsStatus(val) {
				...
				this.$confirm('确定要上架该商品吗？', '提示', {
					...
					_this3.$http.post('/groundingGoods', { goods_id: val, access_token: localStorage.access_token }).then(function (response) {
						var jsondata = response.data;
						that.$message({
							type: jsondata.error_no == 0 ? "success" : "error",
							message: jsondata.error_no == 0 ? "操作成功" : jsondata.error_info
			...
			//批量上架商品
			bathGroundingGoods: function bathGroundingGoods(val) {
				var _this4 = this;
				...
				this.$confirm('确定要上架选中商品吗？', '提示', {
					...
					_this4.$http.post('/bathGroundingGoods', { ids: goods_ids, access_token: localStorage.access_token }).then(function (response) {
						var jsondata = response.data;
						that.$message({
							type: jsondata.error_no == 0 ? "success" : "error",
							message: jsondata.error_no == 0 ? "操作成功" : jsondata.error_info
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('div', {
	  ...
	  }, [_vm._v("用户中心")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("商品管理")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("待发布商品")])], 1)], 1), _vm._v(" "), _c('div', {
	    ...
	    on: {
	      "click": _vm.bathGroundingGoods
	    }
	  }, [_vm._v("批量上架")])], 1), _vm._v(" "), _c('div', {
	    staticClass: "block-white"
	  }, [_c('div', {
	        ...
	        return [_c('el-button', {
	          ...
	          nativeOn: {
	            "click": function($event) {
	              ...
	              _vm.productView(scope.row.goods_id)
	            }
	          }
	          ...
	          nativeOn: {
	            "click": function($event) {
	              $event.preventDefault();
	              _vm.modifyGoods(scope.row.goods_id)
	            }
	          }
	          ...
	          nativeOn: {
	            "click": function($event) {
	              $event.preventDefault();
	              _vm.delGoods(scope.row.goods_id)
	            }
	          }
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-8bc47942", module.exports)
	  }
	}
