...
<html>
		...
		<div id="wrap">
			<div id="left">
				...
				<div class="leftNavi">
					...
					<dl>
						...
						<dd class="leftNaviOns">商品品牌管理</dd>
			...
			<div id="right">
				...
				<div class="rightPos">
					...
					<a class="rightPosCld" href="javascript:;">商品品牌管理</a>
				</div>
				<div class="main">
					<div class="mainTitle boxSizing borBot1">
						<h2 class="boxSizing borBot2">商品品牌管理</h2>
					</div>
					...
					<div class="shade">
						<div class="shadeCon addform">
							<div class="shadeMain">
								<h4 class="borBot2 cor2">新增商品品牌</h4>
								<ul class="addInvite">
									<li class="bor1">
										<label><span>*</span>名称</label>
										<input type="text" name="brand_name" class="brand_name" value="" placeholder="输入商品品牌名称" class="inviteNum" maxlength="8" />
									</li>
									<li class="bor1">
						...
						<div class="shadeCons editform">
							<div class="shadeMain">
								<h4 class="borBot2 cor2">编辑商品品牌</h4>
								<ul class="addInvite">
									<li class="bor1">
										<label><span>*</span>名称</label>
	...
	<script src="/js/brand/productbrand.js" type="text/javascript" charset="utf-8"></script>
