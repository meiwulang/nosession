...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "D:\\eclipse-workspace3\\mall-full-jhd\\mall-uag\\src\\main\\webapp\\app\\components\\newProduct.vue"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    submit: function submit(api) {
	      var _this5 = this;
	
	      this.$refs[this.newProductForm].validate(function (valid) {
	        var bool = _this5.validateForm();
	        if (valid && bool) {
	          _this5.newProductForm.standardList = _this5.newProductForm.standardList.map(function (item) {
	            item.max_sale_num = Number(item.max_sale_num);
	            return item;
	          });
	          _this5.addGoodsEnabled = true;
	          _this5.$http.post(api, _this5.newProductForm).then(function (response) {
	            var jsondata = response.data;
	            if (jsondata.error_no == 0) {
	              _this5.$message({
	                type: "success",
