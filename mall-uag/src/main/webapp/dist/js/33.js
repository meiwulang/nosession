	  ...
	  return _c('div', {
	    ...
	    scopedSlots: _vm._u([{
	      ...
	      fn: function(scope) {
	        ...
	        }, [_vm._v(_vm._s(scope.row.consigneeName))])]), _vm._v(" "), _c('div', [_vm._v(_vm._s(scope.row.consigneeMobile))]), _vm._v(" "), _c('div', [_vm._v(_vm._s(scope.row.inviteCode))])]
	      }
	    }])
	  }), _vm._v(" "), _c('el-table-column', {
	    attrs: {
