...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/xiangyangli/projects/hjh/jhd/mall-uag/src/main/webapp/app/components/modifyProduct.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] modifyProduct.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-33b41c2e", Component.options)
	  } else {
	    hotAPI.reload("data-v-33b41c2e", Component.options)
	  }
	})()}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(29)("273d323e", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-33b41c2e!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modifyProduct.vue", function() {
	     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-33b41c2e!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modifyProduct.vue");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    batchHttps: function batchHttps(arrConfig, callback) {
	      var count = 0,
	          array = new Array();
	      var that = this;
	      arrConfig.map(function (item, index) {
	        that.$http.post(item.url, item.param).then(function (res) {
	          var jsondata = res.data;
	          var _result = jsondata.error_no == 0 ? jsondata.result_list : [];
	          array[index] = _result;
	          count++;
	    ...
	    getQueryGoodsById: function getQueryGoodsById(data) {
	      var _this = this;
	      ...
	      if (this.newProductForm.bannerList.length) {
	        this.bannerFilesList = [];
	        var that = this;
	        this.newProductForm.bannerList = this.newProductForm.bannerList.map(function (item) {
	          that.bannerFilesList.push({
	            url: 'http://test-hjh.oss-cn-shanghai.aliyuncs.com/' + item.banner_url,
	            status: 'finished',
	            uid: item.pic_id
	      ...
	      if (this.newProductForm.detailList.length) {
	        this.detailFilesList = [];
	        var that = this;
	        this.newProductForm.detailList = this.newProductForm.detailList.map(function (item) {
	          that.detailFilesList.push({
	            url: 'http://test-hjh.oss-cn-shanghai.aliyuncs.com/' + item.detail_url,
	            status: 'finished',
	            uid: item.pic_id
	      ...
	      if (this.newProductForm.carModelList) {
	        var carModelListCache = [].concat(this.newProductForm.carModelList);
	        this.newProductForm.carModelList = this.newProductForm.carModelList.map(function (item) {
	          return item.car_models_id;
	        });
	
	        this.carModelTagList = carModelListCache.map(function (item) {
	          _this.carModelOptions.map(function (first) {
	            if (first.value == item.car_brand_id) {
	              ...
	              that.$http.post("/json/901009", param).then(function (resfirst) {
	                var jsondata = resfirst.data;
	                var list = jsondata.error_no == 0 ? jsondata.result_list : [];
	                first.children = list.map(function (item) {
	                  return {
	                ...
	                first.children.map(function (second) {
	                  if (second.value == item.metadata_id) {
	                    ...
	                    that.$http.post("/queryCarModelListWeb", param1).then(function (ressecond) {
	                      var jsondata = ressecond.data;
	                      var list = jsondata.error_no == 0 ? jsondata.result_list : [];
	                      second.children = list.map(function (third) {
	                        var obj = {
	                        ...
	                        if (obj.value == item.car_models_id) {
	    ...
	    /** 获取类目列表 **/
	    getCategoryList: function getCategoryList(options) {
	      this.categoryOptions = options.map(function (item) {
	        return {
	          value: item.category_id,
	          label: item.category_name,
	          children: []
	    ...
	    handleCategoryItemChange: function handleCategoryItemChange(val, handle) {
	      var len = val.length,
	          that = this;
	      var param = {
	        //fatherId : item.value,
	    ...
	    /** 获取类目列表下子级列表 **/
	    getCategoryChildren: function getCategoryChildren(param, target, bool, handle) {
	      var _this2 = this;
	    ...
	    /** 获取机型列表 **/
	    getCarModelList: function getCarModelList(options) {
	      this.carModelOptions = options.map(function (item) {
	        return {
	          value: item.brand_id,
	          label: item.brand_name,
	          children: []
	    ...
	    addGoods: function addGoods() {
	      ...
	      this.$refs[this.newProductForm].validate(function (valid) {
	        var bool = _this3.validateForm();
	
	        if (valid && bool) {
	
	          _this3.newProductForm.standardList = _this3.newProductForm.standardList.map(function (item) {
	            item.max_sale_num = Number(item.max_sale_num);
	            return item;
	          });
	          _this3.$http.post("/modifyGoods", _this3.newProductForm).then(function (response) {
	            var jsondata = response.data;
	            if (jsondata.error_no == 0) {
	              _this3.$message({
	                type: "success",
	              ...
	              window.location.href = _this3.newProductForm.goods_status == 1 ? "#/groundingProduct" : "#/prepareProduct";
	            }
	          });
	        }
	      });
	    ...
	    validateForm: function validateForm() {
	      ...
	      var result = this.newProductForm.standardList.filter(function (item) {
	        return item.standard_must.length + item.optional_first.length + item.optional_second.length > 40;
	      });
	      if (result.length) {
	        this.$message({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v("用户中心")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("商品管理")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("编辑商品")])], 1)], 1), _vm._v(" "), _c('div', {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-33b41c2e", module.exports)
	  }
	}
