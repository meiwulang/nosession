...
import com.hjh.mall.common.core.validation.FutureValidator;
...
public @interface Future {
    ...
    String message() default ValidationConstants.MSG_FUTURE;
    
    Class<? extends Payload>[] payload() default {};
    
    String errorCode() default ValidationErrorCodes.PARAM_NOT_FUTURE;
